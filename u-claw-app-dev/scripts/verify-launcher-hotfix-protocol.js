...
assertIncludes('main.js', main, 'AppData[\\\\/]Local[\\\\/]U-Claw[\\\\/]usb-portable[\\\\/]data-');
...
assertIncludes('Mac script', mac, '--launch-after "$ROOT/U-Claw.app"');
assertIncludes('Windows script', win, '--launch-after "%ROOT%\\U-Claw.exe"');
...
assertIncludes('package-portable.js', packagePortable, "path.join(stageRoot, 'U-Claw.app')");
assertIncludes('package-portable.js', packagePortable, "path.join(stageRoot, 'U-Claw.exe')");
...
assertIncludes('package-portable.js', packagePortable, "'U-Claw Launcher.exe'");
assertIncludes('package-portable.js', packagePortable, "'U-Claw Launcher.app'");
