...
- `verify-ecommerce-workbench-ui.js` runs connected browser acceptance for the ecommerce image workbench upload, platform selection, stubbed image-generation submit, persisted records, and screenshot.
