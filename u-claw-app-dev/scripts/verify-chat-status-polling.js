...
const checks = [
  ...
  [chatSource, "Promise.resolve(ph(e))", "runtime sessions refresh call"],
  [chatSource, "yc(e,{publishRunStatus:!0})", "runtime terminal reconcile after refresh"],
  [
    chatSource,
    "globalThis.setTimeout(()=>uClawRefreshChatStatusNow(e),900)",
    "runtime delayed terminal refresh",
  ],
  [chatSource, "uClawStopChatStatusPoll(e)", "runtime poll cleanup"],
