...
Verifies the Bavi-box UI patch output produced by `patch-openclaw.js`.

## Checks

- Bavi-box first-screen branding.
- Bavi-box manifest metadata.
...
- Official Bavi-box icon files copied into Control UI favicon/apple-touch assets.
- Brand Visual System tokens for Bavi-box blue `#1677ff` primary/accent styling and blue logo assets, plus residual checks against orange color tokens, default `Assistant`, visible Config identity leftovers, Chat failure fallback leftovers, Mobile/Worktrees product-name leftovers, and SkillHub risk-copy leftovers.
