...
const checks = [
  ...
  [cssSource, ".uclaw-config-model-dashboard>.uclaw-config-model-main:last-of-type{grid-template-columns:minmax(0,1fr);align-items:start}", "stacked analytics row"],
  [cssSource, ".uclaw-config-model-dashboard>.uclaw-config-model-main:last-of-type .uclaw-config-model-chart-wrap{min-height:218px}", "bounded trend chart panel"],
  [cssSource, ".uclaw-config-model-dashboard>.uclaw-config-model-main:last-of-type .uclaw-config-model-table table{min-width:980px}", "wide ledger table"],
