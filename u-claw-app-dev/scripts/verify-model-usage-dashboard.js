...
const checks = [
  ...
  [configSource, "账户余额", "balance card"],
  [configSource, "今日用量", "today usage metric"],
  ...
  [configSource, "New API quota", "cloud quota metric label"],
  ...
  [configSource, "placeholder=\"搜索或输入模型 id\"", "model selector search input"],
  ...
  [cssSource, "@media (max-width:1420px){.uclaw-config-model-main{grid-template-columns:1fr}}", "small screen stacks model sections"],
