...
describe("IPC contracts", () => {
  ...
  it("redacts secret-bearing complete IPC outputs and preserves normal status text", () => {
    ...
    const toolResponse = IpcResponseSchema.parse({ method: "tools.get-call", requestId: "request-2", ok: true, result: { id: "tool-1", sessionId: "session-1", toolId: "status", displayName: "Status", state: "running", risk: "low", inputSummary: { tokenCount: 42, apiKeyStatus: "configured" }, outputSummary: { "api-key": "fixture-ipc-secret-1", "access-token": "fixture-ipc-secret-2", authToken: "fixture-ipc-secret-3", sessionCookie: true, privateKey: ["fixture-ipc-secret-4"], token: 123456 } } });
