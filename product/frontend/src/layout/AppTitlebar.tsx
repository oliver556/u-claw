import type { AttachmentIpcRequest, AttachmentIpcResponse, ChannelIpcRequest, ChannelIpcResponse, ClientIpcEvent, ClientIpcRequest, DataBridge, DiagnosticsIpcRequest, DiagnosticsIpcResponse, GatewayStatus, IpcResponse, McpIpcRequest, McpIpcResponse, PluginIpcRequest, PluginIpcResponse, ProviderIpcRequest, ProviderIpcResponse, RecoveryAction, SkillIpcRequest, SkillIpcResponse, WindowIpcRequest } from "@uclaw/shared";
