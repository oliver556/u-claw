...
const runtimeManifest = (): RuntimeManifest => ({
  schemaVersion: 1, productVersion: "0.2.0", nodeVersion: "24.15.0", electronVersion: "40.10.6", runtimeVersion: "2026.7.1-2",
  ...
  entrypoint: "electron/electron.exe", entryArgs: [], signature: { algorithm: "ed25519", keyId: "release-2026", signedAt: "2026-08-09T00:00:00.000Z", expiresAt: "2027-08-09T00:00:00.000Z", sequence: 42, value: "signature" },
});
